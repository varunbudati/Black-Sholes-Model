...
def main():
    ...
    def display_contact_buttons():
        ...
        <div class="contact-container">
            <a href="https://github.com/varunbudati" target="_blank" class="contact-btn" style="background-color:#24292e;">
            ...
            <a href="https://varunbudati.github.io/" target="_blank" class="contact-btn" style="background-color:#4CAF50;">
            ...
            <a href="https://www.linkedin.com/in/varun-budati/" target="_blank" class="contact-btn" style="background-color:#0077B5;">
