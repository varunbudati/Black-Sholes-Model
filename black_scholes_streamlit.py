...
def main():
    ...
    def display_contact_buttons():
        ...
        <div class="contact-container">
            <a href="https://github.com/varunbudati" target="_blank" class="contact-btn" style="background-color:#00FFFFFF;">
            ...
            <a href="https://varunbudati.github.io/" target="_blank" class="contact-btn" style="background-color:#00FFFFFF;">
            ...
            <a href="https://www.linkedin.com/in/varun-budati/" target="_blank" class="contact-btn" style="background-color:#00FFFFFF;">
